...
Public Class struk_pinjam
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Library_Dashboard.struk_pinjam.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedstruk_pinjam
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As struk_pinjam = New struk_pinjam()
        rpt.Site = Me.Site
        Return rpt
    End Function
