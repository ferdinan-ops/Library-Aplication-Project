...
Public Class nota_kembali
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Library_Dashboard.nota_kembali.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednota_kembali
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As nota_kembali = New nota_kembali()
        rpt.Site = Me.Site
        Return rpt
    End Function
